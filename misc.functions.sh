...
alias profile.edit="${EDITOR_COMMAND} $BASH_PROFILE;echo Reloading bash profile;source $BASH_PROFILE && echo Reloading of bash profile was successful."
...
alias edit.pyqerc="${EDITOR_COMMAND} ~/.pyqerc"